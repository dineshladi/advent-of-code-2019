...
def compute_best_steps(line1, line2):
    line1_points = traverse(line1)
    line2_points = traverse(line2)

    intersection_keys = set(line1_points.keys()) & set(line2_points.keys()) 
    return(min([line1_points[x] + line2_points[x] for x in intersection_keys]))
